...
data class LocalizedStrings(
    ...
    // Home Screen
    val randomStoryButton: String,
    val customStoryButton: String,
    val customPromptLabel: String,
    val customPromptPlaceholder: String,
    val generateCustomButton: String,
    ...
    val apiEndpointPlaceholder: String,
    val apiEndpointHelper: String,
    val apiKeyLabel: String,
    val apiKeyPlaceholder: String,
    val apiKeyHelper: String,
    val modelNameLabel: String,
    val modelNamePlaceholder: String,
    val modelNameHelper: String,
    val storyPreferences: String,
    val storyLanguage: String,
    val storyStyle: String,
    val childGender: String,
    val genderBoy: String,
    val genderGirl: String,
    val genderBoth: String,
    val ageRange: String,
    val ageBaby: String,
    val ageToddler: String,
    val ageChild: String,
    val ageOlder: String,
